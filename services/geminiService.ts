...
// FIX: Per coding guidelines, API key must be retrieved from process.env.API_KEY. This also resolves the error "Property 'env' does not exist on type 'ImportMeta'".
